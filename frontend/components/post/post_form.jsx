...
class PostForm extends React.Component {
  ...
  componentDidMount() {
    if (this.props.type === 'update') {
      this.props
        .fetchPost(this.props.current_user.id, this.props.postId)
  ...
  handlePublish() {
    this.props
      .action(this.props.current_user.id, this.state)
  ...
  render() {
    ...
    if (this.props.type === 'create') {
      if (this.state.body) {
        ...
        publishBtn = (
          <a className="post-form-inputs-btn" id="create-post-submit-disabled">
            Publish
          </a>
        );
      }
